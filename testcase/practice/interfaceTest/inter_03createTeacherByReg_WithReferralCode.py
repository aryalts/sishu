...
class CreateTeacherByReg(unittest.TestCase):
    ...
    def test_01(self):
        ...
        referenceCode = col_resume.find_one({"teacherId":globals()["teacherId"]})["refererDetail"]["referenceCode"]
        ...
        try:
            ...
            print("REG创建简历成功,简历ID为:{},推荐人为:{}".format(resumeID,referenceCode))
